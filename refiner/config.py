...
class Settings(BaseSettings):
    ...
    SCHEMA_NAME: str = Field(
        default="Instagram Meta Export Analytics", description="Name of the schema"
    )

    SCHEMA_VERSION: str = Field(default="1.0.0", description="Version of the schema")

    SCHEMA_DESCRIPTION: str = Field(
        default="Schema for the Instagram Meta Export DLP, representing comprehensive Instagram user data including profile, metrics, activities and security information",
